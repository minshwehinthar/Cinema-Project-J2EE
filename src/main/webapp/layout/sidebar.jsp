<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 border-r border-gray-200 flex flex-col">
      ...
      <ul class="space-y-2 font-medium flex-1">
         <li>
            <a href="index.jsp" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
         ...
         <li>
            <a href="booked.jsp" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
         ...
         <li>
            <a href="food.jsp" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
         ...
         <li>
            <a href="users.jsp" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
      ...
      <button class="mt-auto">
         <a href="logout.jsp" class="flex items-center p-2 text-sky-600 rounded-lg">
